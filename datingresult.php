    ...
    <script> 
      ...
      function postToFeed() {
        ...
        var obj = {
          ...
          method: 'feed',
          redirect_uri: 'https://app.nextstyle.co.in/datingresult.php',
          link: 'https://app.nextstyle.co.in/dating.php',
          picture: 'https://appsfun.xyz/dating/<?php echo $resultid; ?>',
...
<div>
<?php echo '<img class="img-responsive center-block"  src="'.$resultid.'" />'; ?>
</div>
        ...
        <div class="row">
          <div class="col-lg-8">            
            <div class="app">
              ...
              <br>
              <img class="img-responsive" src="images/datingresult.png" alt="">           
                                  <br>
